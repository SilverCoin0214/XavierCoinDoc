...
![[Pasted image 20220921154730.png]]
...
`React`在启动时会创建全局对象, 其中在创建[fiberRoot](https://7kms.github.io/react-illustration-series/main/bootstrap#create-root-impl)对象时, 调用[createRootImpl](https://github.com/facebook/react/blob/v17.0.2/packages/react-dom/src/client/ReactDOMRoot.js#L120-L169):
...
![[Pasted image 20220921165125.png]]
...
1.  构造合成事件(`SyntheticEvent`), 添加到派发队列(`dispatchQueue`)
